...
global.channelLink = "https://whatsapp.com/channel/0029Vb6IZrGId7nR7caAqb2q";
global.ytch = "BLACK DEVIL 😈";
...
const channelInfo = {
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            newsletterJid: '120363418958574804@newsletter',
            newsletterName: 'BLACK DEVIL',
            serverMessageId: -1
        }
    }
};
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb6IZrGId7nR7caAqb2q'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/I2gfkMU7hE2K3tbGIQuAGN?mode=gi_t
                }, { quoted: message });
                return;
            }
        }
